      ...
      <section className="py-16 gradient-bg">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center text-white">
            <div>
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">800+<span className="text-xl sm:text-2xl">{language === 'zh' ? '人' : ''}</span></div>
              <div className="text-sm sm:text-base md:text-lg opacity-90">{t('stats.migrants')}</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">150+<span className="text-xl sm:text-2xl">{language === 'zh' ? '人' : ''}</span></div>
            ...
            <div>
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">6<span className="text-xl sm:text-2xl">{language === 'zh' ? '種' : ''}</span></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8">
            ...
            {[
              ...
              { initial: 'M', name: 'Max', role: language === 'zh' ? '創新工程師' : 'Innovation Engineer', desc: language === 'zh' ? '硬體整合 | 跨域專長' : 'Hardware | Multi-domain' },
